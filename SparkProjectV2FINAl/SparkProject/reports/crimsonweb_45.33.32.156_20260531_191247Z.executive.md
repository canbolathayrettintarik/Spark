...
- **Scan time (UTC):** 2026-05-31 19:12:48 UTC
- **Target:** `scanme.nmap.org` (`45.33.32.156`)
- **RoE reference:** `GUI-Authorized`
...
- **Total requests:** 30 (failures: 3)
- **Block events:** 1
    - `http://scanme.nmap.org/.htpasswd` — hard:http_403 (egress=direct)

## Appendix

- **Raw JSON report:** `reports\crimsonweb_45.33.32.156_20260531_191247Z.json`
